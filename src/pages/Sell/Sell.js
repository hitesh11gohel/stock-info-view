...
const Sell = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!date || !code || !quantity || !price) {
      ...
      console.log("sell Data :", sellDetail);
    }
  };
    ...
    <>
      <div className="buy-container">
        ...
        <Box
          className="sell-box"
          component={Paper}
          sx={{ width: "400px", margin: "20px 10px", borderRadius: "10px" }}
        >
              ...
              <Grid item md={9} xs={9}>
                <input
                  ...
                  onBlur={() => {
                    setSellDetail({
                      ...sellDetail,
                      total: sellDetail.quantity * sellDetail.price,
                    });
                  }}
                  onChange={(e) => handleChange(e)}
                />
            ...
            <div className="d-flex flex-column justify-content-center mt-5">
              <div className="text-center">
                <button
                  type="submit"
                  disabled={disableBtn}
                  className="btn btn-primary rounded-pill px-4 w-50 login-btn"
                >
                  Save
                </button>
              </div>
