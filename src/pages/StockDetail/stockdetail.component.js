...
const TableContent = (props) => {
  ...
  return (
    <div className="table-responsive-sm">
      <table
        className={props.sold ? "table table-striped" : "table table-hover"}
      >
              ...
              return (
                <tr key={ele._id}>
                  ...
                  <td style={{ textAlign: "right" }}>
                    {ele.total.toLocaleString("en-IN", {
                      style: "currency",
                      currency: "INR",
                    })}
                  </td>
    ...
    <>
      <Container>
        ...
        >
          ...
          <Grid container spacing={1} className="btn-container">
            <Grid item md={6} xs={6} className="text-center">
              <button
                className={
                  btn.bought
                    ? "btn w-100 border-none fw-bold special-btn"
                    : "btn w-100 border-none fw-bold common-btn"
                }
                onClick={() => setBtn({ bought: true, sold: false })}
              >
                Bought
              </button>
            </Grid>
            <Grid item md={6} xs={6} className="text-center">
              <button
                className={
                  btn.sold
                    ? "btn w-100 fw-bold border-none special-btn"
                    : "btn w-100 border-none fw-bold common-btn"
                }
                onClick={() => setBtn({ sold: true, bought: false })}
              >
                Sold
              </button>
            </Grid>
          ...
          <div>
            <Link to="/buy" className="btn w-50 special-btn buy-btn">
              Buy
            </Link>
          </div>
        </Box>
